...
class ExampleClass1 {
	...
	// [접근제어자] 반환타입 메서드명 (매개변수타입 매개변수명, ...) - 선언부
	// { 메서드의 기능 구현 } - 구현부
	void method1 () {
	...
	// 클래스 메서드에서는 인스턴스 변수 사용 및 인스터스 메서드 호출이 불가능
...
class TriangleMath {
	 ...
	 // Speed of_LightTriangleMath 클래스의 단일 책임 원에 위배됨
