...
// T extends 클래스명: 특정 클래스 혹은 특정 클래스를 상속한 클래스만 제너릭으로 지정할 수 있도록 제
...
public class F_Generic {
	...
	private static final String SuperClass = null;
	...
	public static void main(String[] args) {
		...
		// 제너릭으로 지정하면 컴파일 시 타입을 겨정하여
		//원하는 형태의 데이터 타입으로 사용할 수 있음
		// 제너릭의 타입을 전달한 땐 반드시 참조형 데이터 타입이어야 함
	...
	private static void List(String superclass2) {
