...
public class C_Package2 {
	...
	public static void main(String[] args) {
	    ...
	    // 기본형 데이터 타입의 변수로 리스트의 요소를 받을 땐 null이 올수 있음을 주의
	    ...
	    // Set을 적절히 사용 하면 List의 중복 제거 및 정렬을 손쉽게 수행할 수 있음
	    list = new ArrayList<>();
	    list.add(1);
	    list.add(1);
	    list.add(2);
        ...
        // Map: key와 value가 한 쌍으로 이우어진 요소들의 집합
	    // key는 중복 물가, value는 중복 가능
